...
class HREmployeeEditEmployee extends Component{
    constructor(props){
        super(props);
        this.state = {
            empName : this.props.employeeToEdit.empName,
            empAge : this.props.employeeToEdit.empAge,
            empDept : this.props.employeeToEdit.empDept,
            empRole : this.props.employeeToEdit.empRole,
            empMobNo : this.props.employeeToEdit.empMobNo,
            resd : this.props.employeeToEdit.empAddress.resd,
            locality : this.props.employeeToEdit.empAddress.locality,
            vilcity : this.props.employeeToEdit.empAddress.vilcity,
            pincode : this.props.employeeToEdit.empAddress.pincode,
            empDailyHours : this.props.employeeToEdit.empDailyHours,
            empPayType : this.props.employeeToEdit.empPayType,
            empPay : this.props.employeeToEdit.empPay,
        };
    ...
    handleEdit(event){
        ...
        this.props.employeesPut(this.props.employeeToEdit._id, editEmployee);
                ...
                <div className="container-fluid">
                    <div className="row border-bottom border-secondary bg-light">
                        <div className="mx-5 px-5">
                            <h1 className="font-weight-normal">Edit Employee</h1>
                        </div>
                    </div>
                    <div className="row text-left">
                        <Card className="p-3 mt-5 col-md-8 offset-2 bg-light">
                            <Form onSubmit={this.handleEdit}>
                                ...
                                <FormGroup row>
                                    <Col md={3}>
                                        <Button type="submit" color="info">Edit Employee</Button>
                                    </Col>
                                </FormGroup>
                            </Form>
                        </Card>
...
export default withRouter(HREmployeeEditEmployee);
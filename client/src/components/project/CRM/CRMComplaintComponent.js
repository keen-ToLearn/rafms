...
const RenderTableBody = ({complaints, renderRowList, id, forPid, showResolved, complaintsPostDelete}) => {
    function handleDeletion(sNo){
        complaintsPostDelete(id, sNo, 'DELETE');
    }
    if( complaints === '')
        return(
            <></>
...
class CRMComplaint extends Component{
    ...
    handleSubmit(event){
        ...
        this.props.complaintsPostDelete(this.props.complaints._id, newComplaint, 'POST');
        this.toggleModal();
    }
                    ...
                    <Col md={9}>
                        <div>
                            <Table hover>
                                ...
                                <RenderTableBody complaints={this.state.complaints} renderRowList={this.state.renderRowList} id={this.props.complaints._id}

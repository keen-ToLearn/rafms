...
const RenderTableBody = ({salesDetails, renderRowList, forPid, salesPostDelete, id}) => {
    function handleDeletion(sNo){
        salesPostDelete(id, sNo, 'DELETE');
    }
                        ...
                        <div ref={(ref) => { this.salesOverview = ref }}>
                            <Table hover>
                                ...
                                <RenderTableBody salesDetails={this.state.sales} renderRowList={this.state.renderRowList}
                                    forPid={this.props.sales.forPid} salesPostDelete={this.props.salesPostDelete} id={this.props.sales._id}/>
                            </Table>
                        </div>
                    </Col>
                    <Col md={3}>

...
export const Employees = (state = {
    ...
    switch(action.type){
        ...
        case ActionTypes.EMPLOYEES_PUT:
            ...
            employeesCopy[editEmployee.sNo - 1] = editEmployee;
        ...
        case ActionTypes.EMPLOYEES_ADDLEAVE:
            ...
            employeesDuplicate[employeeWithLeave.sNo - 1] = employeeWithLeave;
        ...
        case ActionTypes.EMPLOYEES_UNMARK:
            ...
            employeesFaux[employeeUnmarked.sNo - 1] = employeeUnmarked;

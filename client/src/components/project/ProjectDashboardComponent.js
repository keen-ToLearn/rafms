                ...
                if(typeof projectViewComplaint === 'undefined'){
                    ...
                    return(
                        <CRMComplaintViewComplaint complaintToView={projectViewComplaint} forPid={this.props.complaints.forPid}
                            id={this.props.complaints._id} complaintsPostDelete={this.props.complaintsPostDelete}/>
                    );
            }
        }
        ...
        const RenderSMEditSales = ({match}) => {
            if(this.props.isLoadingSales){
                ...
                if(typeof projectEditSale === 'undefined'){
                    ...
                    return (
                        <SMSalesEditSales saleToEdit={projectEditSale} salesPostDelete={this.props.salesPostDelete}
                            id={this.props.sales._id} forPid={this.props.sales.forPid}/>
                    );
            }
        }
            ...
            <div className="col-11 p-0">
                <Switch>
                    <Route exact path={`/usermain/${this.props.selectedProject.pid}`} component={() => <ProjectInfo selectedProject={this.props.selectedProject}/>}/>
                        ...
                        <Route path={`/usermain/${this.props.selectedProject.pid}/sales_management/add_sale`} component={() => <SMSalesAddSales forPid={this.props.sales.forPid} id={this.props.sales._id}
                            recordsLength={this.props.sales.records.length} salesPostDelete={this.props.salesPostDelete}/>}/>

...
const mapDispatchToProps = dispatch => ({
    ...
    projectsPut : (pData) => dispatch(projectsPut(pData)),
    ...
    employeesPut : (eData) => dispatch(employeesPut(eData)),
    ...
    render(){
        ...
        return(
            <Switch>
                ...
                <Route path="/userlogin" component={() => <UserLogin login={this.props.login} usersLogInOut={this.props.usersLogInOut}/>}/>
